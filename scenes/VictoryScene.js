export default class VictoryScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.text_params = { fontSize: '85px', fill: '#000000', fontFamily: 'Brush Script MT', fontWeight: 'bold' };
        this.text = 'Loot items';
        this.lootText = this.add.text(512, 140, this.text, this.text_params).setOrigin(0.5, 0.5);
        ...
        const rectWidth = (maxItemsPerRow * itemSize) + ((maxItemsPerRow - 1) * gap) + 50;
        ...
        Object.keys(lootInfo).forEach((item) => {
            ...
            this.add.sprite(currentX, currentY, item).setOrigin(0, 0).setScrollFactor(0);
            if (lootInfo[item] > 1) {
                this.add.text(currentX - 5, currentY - 5, `x${lootInfo[item]}`, {fontSize: '22px', fill: '#ffffff', fontFamily: 'Arial', fontWeight: 'bold'}).setOrigin(0, 0).setScrollFactor(0);
            }
