    ...
    setupEnemies(data) {
        ...
        enemiesToCreate.forEach((enemyName, index) => {
            ...
            try {
                ...
                this.enemySprites.push(enemyRect);
    ...
    updateEnemyMovement() {
        ...
        this.enemySprites.forEach((sprite, index) => {
            if (sprite && this.enemies[index]) {
                ...
                if (sprite.x < 600)
                    sprite.x = 600; // Don't go too far left
                if (sprite.x > 1400)
                    sprite.x = 1400; // Don't go too far right
            }
        });
    }
    performAttack() {
...
//# sourceMappingURL=BattleSceneSimple.js.map