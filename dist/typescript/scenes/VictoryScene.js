...
export class VictoryScene extends Phaser.Scene {
    ...
    processExperienceGain(experienceGained) {
        const services = this.bridge.getServices();
    ...
    processLoot(enemyLoot) {
        ...
        enemyLoot.forEach((weaponIndex) => {
            ...
            if (medChance <= 25) {
                ...
                const medName = this.medicalItems[medIndex];
    ...
    displayResults(lootInfo, experienceGained) {
        // Title text
