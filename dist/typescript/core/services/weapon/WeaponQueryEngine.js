...
export class WeaponQueryEngine {
     ...
     */
    getWeaponsByDamageRange(minDamage, maxDamage) {
        const weapons = this.weaponRegistry.getAllWeapons();
     ...
     */
    getWeaponsByCooldownRange(minCooldown, maxCooldown) {
        const weapons = this.weaponRegistry.getAllWeapons();
        const results = weapons.filter(weapon => weapon.cooldown >= minCooldown && weapon.cooldown <= maxCooldown);
     ...
     */
    getWeaponsByCriticalChance(minCritical, maxCritical) {
        const weapons = this.weaponRegistry.getAllWeapons();
        const results = weapons.filter(weapon => {
     ...
     */
    getWeaponsByClipSize(minClipSize, maxClipSize) {
        const weapons = this.weaponRegistry.getAllWeapons();
        const results = weapons.filter(weapon => {
            return maxClipSize ?
     ...
     */
    searchWeaponsByName(pattern, caseSensitive = false) {
        const weapons = this.weaponRegistry.getAllWeapons();
     ...
     */
    getWeaponsSortedByDamage(ascending = false) {
        const weapons = this.weaponRegistry.getAllWeapons();
     ...
     */
    getWeaponsSortedByCooldown(ascending = true) {
        const weapons = this.weaponRegistry.getAllWeapons();
        const results = weapons.sort((a, b) => {
     ...
     */
    recordQuery(queryType, parameters, resultCount) {
...
//# sourceMappingURL=WeaponQueryEngine.js.map