...
export default class BattleScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.hand_sprite = this.add
            .sprite(this.cameras.main.width - 115, this.cameras.main.height - 88, "hand " + this.chosenWeapon.name)
            .setScrollFactor(0);
    ...
    update() {
        ...
        if (this.playerHealth < this.maxPlayerHealth / 2 &&
        ...
        else if (this.playerHealth <= this.maxPlayerHealth / 4 &&
            this.playerHealth >= 0) {
        ...
        else if (this.playerHealth >= this.maxPlayerHealth / 2 ||
            this.playerHealth <= 0) {
        ...
        let crosshairRect = new Phaser.Geom.Rectangle(cameraX + this.crosshair_red.x - this.crosshair_red.width / 2, cameraY + this.crosshair_red.y - this.crosshair_red.height / 2, this.crosshair_red.width, this.crosshair_red.height);
    ...
    show_stats() {
        ...
        this.heroStatsTexts.push(this.add
            .text(710, 20, `Level ${this.gameData.levelCount}: ${this.gameData.experience}/1000`, hero_data_text_params)
            .setScrollFactor(0));
        this.heroStatsTexts.push(this.add
            .text(710, 40, `Armor Class: ${this.chosenArmor.ac}`, hero_data_text_params)
            .setScrollFactor(0));
        this.heroStatsTexts.push(this.add
            .text(710, 60, `Threshold: ${this.chosenArmor.threshold}`, hero_data_text_params)
            .setScrollFactor(0));
        this.heroStatsTexts.push(this.add
            .text(710, 80, `Resistance: ${Math.round(this.chosenArmor.resistance * 100)}%`, hero_data_text_params)
            .setScrollFactor(0));
        this.heroStatsTexts.push(this.add
            .text(710, 100, `Damage: ${Math.round(this.chosenWeapon.damage.min)}-${Math.round(this.chosenWeapon.damage.max)}`, hero_data_text_params)
            .setScrollFactor(0));
        this.heroStatsTexts.push(this.add
            .text(710, 120, `Cooldown: ${this.chosenWeapon.cooldown / 1000}s`, hero_data_text_params)
            .setScrollFactor(0));
        this.heroStatsTexts.push(this.add
            .text(710, 140, `Critical: ${this.critical_chance}%`, hero_data_text_params)
            .setScrollFactor(0));
    }
    use_first_aid_kit() {
    ...
    switchWeapon(next) {
        ...
        const nextIndex = (currentIndex + next + this.gameData.weapons.length) %
    ...
    crosshairRect() {
        ...
        return new Phaser.Geom.Rectangle(cameraX + this.crosshair_red.x - this.crosshair_red.width / 2, cameraY + this.crosshair_red.y - this.crosshair_red.height / 2, this.crosshair_red.width, this.crosshair_red.height);
    }
    enemyAttack(enemy) {
        if (enemy.canAttack) {
    ...
    fireWeapon() {
        ...
        if (currentTime - this.lastShotTime[this.chosenWeapon.name] >= cooldown) {
            ...
            if (this.bullets_in_current_clip >= this.chosenWeapon.shots ||
    ...
    reload() {
        if (this.chosenWeapon.type !== "melee") {
            if (this.gameData.ammo[this.chosenWeapon.type] > 0 &&
