...
export default class BattleScene extends Phaser.Scene {
  constructor() {
    ...
    ]; // Замените на реальные названия треков
  ...
  preload() {
    for (let i = 1; i <= this.amountOfMainBackgrounds; i++) {
      this.load.image(
        "backgroundMain" + i,
        "assets/images/backgrounds/battle/backgroundMain" + i + ".png"
      );
    }
    this.armors.forEach((armor) => {
      this.load.image(
        "armor " + armor.name,
        "assets/images/armors/" + armor.name + ".png"
      );
    });
    this.armors_red = [
      "Leather Jacket",
    ...
    this.armors_red.forEach((armor) => {
      this.load.image(
        "armor red " + armor,
        "assets/images/armors_red/" + armor + ".png"
      );
    });
    ...
    this.weapons.forEach((weapon) => {
      this.load.image(
        "weapon " + weapon.name,
        "assets/images/weapons/" + weapon.name + ".png"
      );
      this.load.image(
        "hand " + weapon.name,
        "assets/images/hands/" + weapon.name + ".png"
      );
    });
    ...
    this.load.image(
      "crosshair_red",
      "assets/images/crosshairs/crosshair_red.png"
    );
    this.load.image(
      "crosshair_green",
      "assets/images/crosshairs/crosshair_green.png"
    );
    this.load.image(
      "indicator green",
      "assets/images/health_indicators/green.png"
    );
    this.load.image(
      "indicator yellow",
      "assets/images/health_indicators/yellow.png"
    );
    ...
    this.medcine.forEach((med) => {
      this.load.image(
        med + " grey",
        "assets/images/medcine/grey/" + med + ".png"
      );
    });
    this.weapons.forEach((weapon) => {
      this.load.audio(weapon.name + " - hit", [
        "assets/sounds/weapons/" + weapon.name + " - hit.mp3",
      ]);

      // Предположим, что у вас есть до трех звуков промаха для каждого оружия
      for (let j = 1; j <= 3; j++) {
        this.load.audio(weapon.name + " - miss " + j, [
          "assets/sounds/weapons/" + weapon.name + " - miss " + j + ".mp3",
        ]);
      }
    });
    ...
    this.load.audio(
      "Mantis - attack",
      "assets/sounds/enemies/Mantis - attack.mp3"
    );
    this.load.audio(
      "Mantis - wounded",
      "assets/sounds/enemies/Mantis - wounded.mp3"
    );
    this.load.audio("Mantis - died", "assets/sounds/enemies/Mantis - died.mp3");
    this.load.audio(
      "Spear - attack",
      "assets/sounds/enemies/Spear - attack.mp3"
    );
    this.load.audio(
      "Knife - attack",
      "assets/sounds/enemies/Knife - attack.mp3"
    );

    this.load.audio(
      "Tribe man 1 - wounded",
      "assets/sounds/enemies/Tribe man 1 - wounded.mp3"
    );
    this.load.audio(
      "Tribe man 2 - wounded",
      "assets/sounds/enemies/Tribe man 2 - wounded.mp3"
    );
    this.load.audio(
      "Tribe man 3 - wounded",
      "assets/sounds/enemies/Tribe man 3 - wounded.mp3"
    );
    this.load.audio(
      "Tribe man 4 - wounded",
      "assets/sounds/enemies/Tribe man 4 - wounded.mp3"
    );
    this.load.audio(
      "Tribe man 1 - died",
      "assets/sounds/enemies/Tribe man 1 - died.mp3"
    );
    this.load.audio(
      "Tribe man 2 - died",
      "assets/sounds/enemies/Tribe man 2 - died.mp3"
    );
    this.load.audio(
      "Tribe man 3 - died",
      "assets/sounds/enemies/Tribe man 3 - died.mp3"
    );
    this.load.audio(
      "Tribe man 4 - died",
      "assets/sounds/enemies/Tribe man 4 - died.mp3"
    );
    this.load.audio(
      "Tribe woman 1 - wounded",
      "assets/sounds/enemies/Tribe woman 1 - wounded.mp3"
    );
    this.load.audio(
      "Tribe woman 2 - wounded",
      "assets/sounds/enemies/Tribe woman 2 - wounded.mp3"
    );
    this.load.audio(
      "Tribe woman 1 - died",
      "assets/sounds/enemies/Tribe woman 1 - died.mp3"
    );
    this.load.audio(
      "Tribe woman 2 - died",
      "assets/sounds/enemies/Tribe woman 2 - died.mp3"
    );
    this.load.audio(
      "Cannibal man 1 - wounded",
      "assets/sounds/enemies/Cannibal man 1 - wounded.mp3"
    );
    this.load.audio(
      "Cannibal man 2 - wounded",
      "assets/sounds/enemies/Cannibal man 2 - wounded.mp3"
    );
    this.load.audio(
      "Cannibal man 3 - wounded",
      "assets/sounds/enemies/Cannibal man 3 - wounded.mp3"
    );
    this.load.audio(
      "Cannibal man 1 - died",
      "assets/sounds/enemies/Cannibal man 1 - died.mp3"
    );
    this.load.audio(
      "Cannibal man 2 - died",
      "assets/sounds/enemies/Cannibal man 2 - died.mp3"
    );
    this.load.audio(
      "Cannibal man 3 - died",
      "assets/sounds/enemies/Cannibal man 3 - died.mp3"
    );
    this.load.audio(
      "Cannibal woman 1 - wounded",
      "assets/sounds/enemies/Cannibal woman 1 - wounded.mp3"
    );
    this.load.audio(
      "Cannibal woman 2 - wounded",
      "assets/sounds/enemies/Cannibal woman 2 - wounded.mp3"
    );
    this.load.audio(
      "Cannibal woman 1 - died",
      "assets/sounds/enemies/Cannibal woman 1 - died.mp3"
    );
    this.load.audio(
      "Cannibal woman 2 - died",
      "assets/sounds/enemies/Cannibal woman 2 - died.mp3"
    );
    ...
    this.load.audio("enemy killed", [
      "assets/sounds/enemy_killed/enemy_killed.mp3",
    ]);
  ...
  create() {
    ...
    this.first_aid_kit_key = this.input.keyboard.addKey(
      Phaser.Input.Keyboard.KeyCodes.Z
    );
    this.jet_key = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.X);
    this.buffout_key = this.input.keyboard.addKey(
      Phaser.Input.Keyboard.KeyCodes.C
    );
    this.mentats_key = this.input.keyboard.addKey(
      Phaser.Input.Keyboard.KeyCodes.V
    );
    this.psycho_key = this.input.keyboard.addKey(
      Phaser.Input.Keyboard.KeyCodes.B
    );

    let randomNumberBackground = Phaser.Math.Between(
      1,
      this.amountOfMainBackgrounds
    );
    this.background = this.add
      .image(0, 0, "backgroundMain" + randomNumberBackground)
      .setOrigin(0, 0);
    ...
    const foundArmor = this.armors.find(
      (armor) => armor.name === this.chosenArmorName
    );
    this.chosenArmor = JSON.parse(JSON.stringify(foundArmor));
    this.playerRedArmor = this.add
      .sprite(924, 100, "armor red " + this.chosenArmor.name)
      .setScrollFactor(0);
    this.playerArmor = this.add
      .sprite(924, 100, "armor " + this.chosenArmor.name)
      .setScrollFactor(0);
    ...
    const foundWeapon = this.weapons.find(
      (weapon) => weapon.name === this.chosenWeaponName
    );
    ...
    this.crosshair_red = this.add
      .sprite(512, 300, "crosshair_red")
      .setScrollFactor(0);
    this.crosshair_green = this.add
      .sprite(512, 300, "crosshair_green")
      .setScrollFactor(0)
      .setVisible(false);
    ...
    this.first_aid_kit_grey = this.add
      .sprite(20, 490, "first_aid_kit grey")
      .setOrigin(0, 0)
      .setScrollFactor(0);
    this.jet_grey = this.add
      .sprite(20, 490, "jet grey")
      .setOrigin(0, 0)
      .setScrollFactor(0);
    this.buffout_grey = this.add
      .sprite(20, 490, "buffout grey")
      .setOrigin(0, 0)
      .setScrollFactor(0);
    this.mentats_grey = this.add
      .sprite(20, 490, "mentats grey")
      .setOrigin(0, 0)
      .setScrollFactor(0);
    this.psycho_grey = this.add
      .sprite(20, 490, "psycho grey")
      .setOrigin(0, 0)
      .setScrollFactor(0);

    this.first_aid_kit = this.add
      .sprite(20, 490, "first_aid_kit")
      .setOrigin(0, 0)
      .setScrollFactor(0)
      .setVisible(false);
    this.jet = this.add
      ...
      .setScrollFactor(0)
      .setVisible(false);
    this.buffout = this.add
      .sprite(20, 490, "buffout")
      .setOrigin(0, 0)
      .setScrollFactor(0)
      .setVisible(false);
    this.mentats = this.add
      .sprite(20, 490, "mentats")
      .setOrigin(0, 0)
      .setScrollFactor(0)
      .setVisible(false);
    this.psycho = this.add
      .sprite(20, 490, "psycho")
      .setOrigin(0, 0)
      .setScrollFactor(0)
      .setVisible(false);
    ...
    if (this.chosenWeapon.type !== "melee") {
      this.ammo_sprite = this.add
        .sprite(25, 495, this.chosenWeapon.type)
        .setOrigin(0, 0)
        .setScrollFactor(0);
  ...
  update() {
    ...
    if (
      ...
      this.playerHealth > this.maxPlayerHealth / 4
    ) {
    ...
    // escape
    if (
      this.escape_button.visible &&
      Phaser.Input.Keyboard.JustDown(this.shiftKey)
    ) {
      this.gameData.ammo[this.chosenWeapon.type] +=
    ...
    if (this.enemies.length === 0) {
      ...
      if (this.tempLootArmors.length > 0) {
        ...
        let best = this.tempLootArmors.sort(
          (a, b) => armorOrder.indexOf(b) - armorOrder.indexOf(a)
        )[0];
    ...
    this.updateItemVisibility(
      this.gameData.med.first_aid_kit,
      this.first_aid_kit,
      this.first_aid_kit_grey
    );
    this.updateItemVisibility(this.gameData.med.jet, this.jet, this.jet_grey);
    this.updateItemVisibility(
      this.gameData.med.buffout,
      this.buffout,
      this.buffout_grey
    );
    this.updateItemVisibility(
      this.gameData.med.mentats,
      this.mentats,
      this.mentats_grey
    );
    this.updateItemVisibility(
      this.gameData.med.psycho,
      this.psycho,
      this.psycho_grey
    );
  ...
  playEnemyAttackSound(enemy, isHit) {
    if (enemy.attack.weapon) {
      ...
      if (isHit) {
        ...
        const missKey =
          enemy.attack.weapon + " - miss " + Phaser.Math.Between(1, 3);
  ...
  bloodSplashEffect() {
    let bloodSplash = this.add
      .image(this.cameras.main.centerX, this.cameras.main.centerY, "blood")
      .setDepth(50)
      .setScrollFactor(0);
  ...
  show_stats() {
    ...
    this.heroStatsTexts.push(
      this.add
        .text(
          710,
          20,
          `Level ${this.gameData.levelCount}: ${this.gameData.experience}/1000`,
          hero_data_text_params
        )
        .setScrollFactor(0)
    );
    this.heroStatsTexts.push(
      this.add
        .text(
          710,
          40,
          `Armor Class: ${this.chosenArmor.ac}`,
          hero_data_text_params
        )
        .setScrollFactor(0)
    );
    this.heroStatsTexts.push(
      this.add
        .text(
          710,
          60,
          `Threshold: ${this.chosenArmor.threshold}`,
          hero_data_text_params
        )
        .setScrollFactor(0)
    );
    ...
    this.heroStatsTexts.push(
      this.add
        .text(
          710,
          100,
          `Damage: ${Math.round(this.chosenWeapon.damage.min)}-${Math.round(
            this.chosenWeapon.damage.max
          )}`,
          hero_data_text_params
        )
        .setScrollFactor(0)
    ...
    this.heroStatsTexts.push(
      this.add
        .text(
          710,
          120,
          `Cooldown: ${this.chosenWeapon.cooldown / 1000}s`,
          hero_data_text_params
        )
        .setScrollFactor(0)
    );
  ...
  use_psycho() {
    if (this.gameData.med.psycho > 0) {
      ...
      console.log(
        "Using psycho, damage +25%, resistance + 25%, threshold +1, enemy speed + 2s, hero speed +0.5, AC +5, critical_chance +3%"
      );
  ...
  updateHealthDisplay() {
    ...
    const healthHeight =
      (this.playerHealth / this.maxPlayerHealth) * this.playerArmor.height;
  ...
  switchWeapon(next) {
    ...
    this.bullets_in_current_clip = 0;
    const currentIndex = this.gameData.weapons.indexOf(
      this.gameData.current_weapon
    );
    const nextIndex =
      (currentIndex + next + this.gameData.weapons.length) %
      this.gameData.weapons.length;
    this.gameData.current_weapon = this.gameData.weapons[nextIndex];
    const foundWeapon = this.weapons.find(
      (weapon) => weapon.name === this.gameData.current_weapon
    );
    this.chosenWeapon = JSON.parse(JSON.stringify(foundWeapon));
    this.reload();
    this.updateClipBar();
  ...
  createEnemy(enemy_name) {
    ...
    const enemy_obj = this.enemies_all.find((enemy) =>
      enemy.title.includes(enemy_name)
    );
    ...
    const startTween = () => {
      ...
      if (!enemy.rectangle) {
        enemy.rectangle = new Phaser.Geom.Rectangle(
          enemy.x - enemy.displayWidth / 2,
          enemy.y - enemy.displayHeight / 2,
          enemy.displayWidth,
          enemy.displayHeight
  ...
  enemyAttack(enemy) {
    if (enemy.canAttack) {
      ...
      if (hitChance < enemy.attack.hit_chance) {
        // если враг папал
        let checkAc = Phaser.Math.Between(0, 100); // проверка AC игрока
        if (checkAc > this.chosenArmor.ac) {
          // если AC игрока не помог
          let totalDamage = 0;
          for (let i = 0; i < enemy.attack.shots; i++) {
            totalDamage += Phaser.Math.Between(
          ...
          console.log(
            `You were hit by ${enemy.name} on ${Math.round(totalDamage)}`
          );
  ...
  fireWeapon() {
    ...
    if (currentTime - this.lastShotTime[this.chosenWeapon.name] >= cooldown) {
      ...
      if (
        this.bullets_in_current_clip >= this.chosenWeapon.shots ||
        this.chosenWeapon.type === "melee"
      ) {
        if (this.chosenWeapon.type !== "melee") {
        ...
        if (enemy_to_hit) {
          ...
          if (roll_hit_chance < this.gameData.skills[this.chosenWeapon.skill]) {
            ...
            for (let i = 0; i < this.chosenWeapon.shots; i++) {
              ...
              if (Phaser.Math.Between(0, 100) > enemy_to_hit.defence.ac) {
                // Если преодолена броня
                bulletDamage = Phaser.Math.Between(
                  this.chosenWeapon.damage.min,
                  this.chosenWeapon.damage.max
                );
              } else {
                console.log(
                  `${enemy_to_hit.name} endures damage without consequences.`
                );
              ...
              if (totalDamage === 0) {
                ...
                this.sound.play(
                  this.chosenWeapon.name + " - miss " + missSoundNumber
                );
              }
            }
            if (totalDamage !== 0) {
              ...
              if (was_critical_or_not > this.critical_chance) {
                ...
                console.log(
                  `${enemy_to_hit.name} was hit for ${Math.round(
                    totalDamage
                  )} hitpoints.`
                );
              } else {
                ...
                if (roll_critical > 20 && roll_critical < 46) {
                  totalDamage *= 1.5;
                  console.log(
                    `[Critical Damage x1.5 (Ignores Armor)] ${enemy_to_hit.name} was hit for ${totalDamage}.`
                  );
                } else if (roll_critical > 45 && roll_critical < 91) {
                  totalDamage *= 2;
                  console.log(
                    `[Critical Damage x2 (Ignores Armor)] ${enemy_to_hit.name} was hit for ${totalDamage}.`
                  );
                } else if (roll_critical > 90 && roll_critical < 98) {
                  totalDamage *= 3;
                  console.log(
                    `[Critical Damage x3 (Ignores Armor)] ${enemy_to_hit.name} was hit for ${totalDamage}.`
                  );
                } else if (roll_critical > 97) {
                  // Instant Death
                  totalDamage *= 100; // Множитель урона
                  console.log(
                    `[Critical Damage (Instant death)] ${enemy_to_hit.name} was hit for ${totalDamage}.`
                  );
                  ...
                  console.log(
                    `[Critical Damage x1.5] ${enemy_to_hit.name} was hit for ${totalDamage}.`
                  );
                }
              }
