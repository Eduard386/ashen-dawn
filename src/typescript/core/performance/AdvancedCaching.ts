...
export class AdvancedCache<T = any> {
   ...
   */
  public setMultiple(entries: Map<string, T>, ttl?: number): void {
...
export class MultiLevelCache<T = any> {
  private l1Cache: AdvancedCache<T>; // Fast, small cache
  private l2Cache: AdvancedCache<T>; // Larger, slower cache
  private stats = {
    l1Hits: 0,
    l2Hits: 0,
    misses: 0
...
export const globalDataCache = new MultiLevelCache(
