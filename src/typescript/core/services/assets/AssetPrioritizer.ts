...
export class AssetPrioritizer {
  private criticalAssets: AssetManifest = { images: {}, audio: {}, video: {} };
  private gameAssets: AssetManifest = { images: {}, audio: {}, video: {} };
  
  // Priority mapping
  private readonly priorityValues: Record<AssetPriority, number> = {
    critical: 1000,
    high: 800,
    normal: 500,
    low: 200,
   ...
   */
  private setupCriticalAssets(): void {
    this.criticalAssets = {
      images: {
        // Main menu
   ...
   */
  public getCriticalAssets(): AssetManifest {
   ...
   */
  public getGameAssets(): AssetManifest {
   ...
   */
  public getAssetsByPriority(includeGame: boolean = true): AssetItem[] {
   ...
   */
  public getAssetsInChunks(chunkSize: number = 20): AssetItem[][] {
   ...
   */
  public getSceneAssets(sceneName: string): AssetItem[] {
   ...
   */
  public getAssetPriority(key: string, type: 'image' | 'audio' | 'video'): AssetPriority {
    // Critical assets
   ...
   */
  public getAssetCountsByPriority(): Record<AssetPriority, number> {
  ...
  private addGameAssetsWithPriority(assets: AssetItem[]): void {
    this.addAssetsFromManifest(assets, this.gameAssets, 'game');
  }

  private isInManifest(key: string, manifest: AssetManifest): boolean {
