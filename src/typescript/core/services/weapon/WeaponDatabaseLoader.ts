...
export class WeaponDatabaseLoader {
   ...
   */
  public loadWeaponArray(weapons: IWeapon[], source: string = 'array'): {
    loaded: number;
    failed: number;
    errors: string[];
  } {
   ...
   */
  public loadWeaponsFromJSON(jsonData: string, source: string = 'json'): {
    loaded: number;
    failed: number;
    errors: string[];
  } {
   ...
   */
  public loadWeaponsFromMap(weaponMap: Record<string, IWeapon>, source: string = 'map'): {
    loaded: number;
    failed: number;
    errors: string[];
  } {
   ...
   */
  public clearLoadingHistory(): void {
    this.loadingHistory = [];
  }
   ...
   */
  private getDefaultWeaponData(): IWeapon[] {
    return [
      // Melee Weapons
      {
        name: 'baseball_bat',
   ...
   */
  private recordLoading(loadType: string, weaponCount: number, source: string): void {
